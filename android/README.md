...
```gradle
dependencies {
    implementation 'com.github.apiverve:countryborders-api:1.1.12'
}
```
...
```java
import com.apiverve.countryborders.CountryBordersAPIClient;
import com.apiverve.countryborders.APIResponse;
import com.apiverve.countryborders.APIException;

// Initialize the client
CountryBordersAPIClient client = new CountryBordersAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/countryborders](https://docs.apiverve.com/ref/countryborders)
...
- **Documentation:** [https://docs.apiverve.com/ref/countryborders](https://docs.apiverve.com/ref/countryborders)
- **Issues:** [GitHub Issues](https://github.com/apiverve/countryborders-api/issues)
